...
public enum SVGImages {
	...
	private SVGImages() {
		...
		try {
			InputStream is = this.getClass().getResourceAsStream("/UIElements/flag_us.svg");
			flagUs = Util.inputStreamToString(is);
			
			is = this.getClass().getResourceAsStream("/UIElements/fist.svg");
			fist = Util.inputStreamToString(is);
			fist = setColour(fist, PresetColour.BASE_BLACK);
			
			is = this.getClass().getResourceAsStream("/InventoryIcons/displacedWarningIcon.svg");
			displacedIcon = Util.inputStreamToString(is);

			is = this.getClass().getResourceAsStream("/InventoryIcons/concealed.svg");
			concealedIcon = Util.inputStreamToString(is);
			
			is = this.getClass().getResourceAsStream("/InventoryIcons/dirtyIcon.svg");
			dirtyIcon = Util.inputStreamToString(is);

			is = this.getClass().getResourceAsStream("/InventoryIcons/lipstickIcon.svg");
			lipstickIcon = Util.inputStreamToString(is);
			
			is = this.getClass().getResourceAsStream("/InventoryIcons/feminineWarningIcon.svg");
			feminineWarningIcon = Util.inputStreamToString(is);
			feminineWarningIcon = setColour(feminineWarningIcon, PresetColour.FEMININE);

			is = this.getClass().getResourceAsStream("/InventoryIcons/masculineWarningIcon.svg");
			...
			is = this.getClass().getResourceAsStream("/InventoryIcons/jinxed.svg");
			jinxedIcon = Util.inputStreamToString(is);
			jinxedIcon = setColour(jinxedIcon, PresetColour.ATTRIBUTE_CORRUPTION);

			is = this.getClass().getResourceAsStream("/InventoryIcons/tattooSwitchTattoo.svg");
			tattooSwitchTattoo = Util.inputStreamToString(is);

			is = this.getClass().getResourceAsStream("/InventoryIcons/tattooSwitchClothing.svg");
			tattooSwitchClothing = Util.inputStreamToString(is);

			is = this.getClass().getResourceAsStream("/InventoryIcons/scar.svg");
			scarIcon = Util.inputStreamToString(is);

			is = this.getClass().getResourceAsStream("/UIElements/menu.svg");
			menuIcon = Util.inputStreamToString(is);

			is = this.getClass().getResourceAsStream("/UIElements/inventory.svg");
			...
			is = this.getClass().getResourceAsStream("/UIElements/questInventory.svg");
			...
			is = this.getClass().getResourceAsStream("/UIElements/itemsOnFloor.svg");
			...
			is = this.getClass().getResourceAsStream("/UIElements/cornerGlow.svg");
			cornerGlowNight = Util.inputStreamToString(is);
			cornerGlowNight = setColour(cornerGlowNight, PresetColour.BASE_PITCH_BLACK);

			is = this.getClass().getResourceAsStream("/UIElements/cornerGlowLight.svg");
			...
			is = this.getClass().getResourceAsStream("/UIElements/diskLoad.svg");
			...
			is = this.getClass().getResourceAsStream("/UIElements/diskDelete.svg");
			...
			is = this.getClass().getResourceAsStream("/map/playerIcon.svg");
			...
			is = this.getClass().getResourceAsStream("/statusEffects/race/raceBackground.svg");
			raceBackground = Util.inputStreamToString(is);

			is = this.getClass().getResourceAsStream("/statusEffects/race/raceBackgroundHalf.svg");
			raceBackgroundHalf = Util.inputStreamToString(is);

			is = this.getClass().getResourceAsStream("/statusEffects/race/raceBackgroundSlime.svg");
			raceBackgroundSlime = Util.inputStreamToString(is);

			is = this.getClass().getResourceAsStream("/statusEffects/race/raceBackgroundDemon.svg");
			raceBackgroundDemon = Util.inputStreamToString(is);
			
			
			
			is = this.getClass().getResourceAsStream("/statusEffects/race/raceUnknown.svg");
			raceUnknown = Util.inputStreamToString(is);
			raceUnknown = setColour(raceUnknown, PresetColour.RACE_UNKNOWN);
			
			is = this.getClass().getResourceAsStream("/statusEffects/race/raceDogMorphDobermann.svg");
			...
			is = this.getClass().getResourceAsStream("/statusEffects/race/raceWisp.svg");
			raceWisp = Util.inputStreamToString(is);
			
			
			is = this.getClass().getResourceAsStream("/UIElements/perkTreeArrow.svg");
			perkTreeArrow = Util.inputStreamToString(is);
			
			is = this.getClass().getResourceAsStream("/combat/spell/spell_overlay.svg");
			spellOverlay = Util.inputStreamToString(is);

			is = this.getClass().getResourceAsStream("/clothing/wrist_womens_watch_hourhand.svg");
			womensWatchHourHand = Util.inputStreamToString(is);
			is = this.getClass().getResourceAsStream("/clothing/wrist_womens_watch_minutehand.svg");
			womensWatchMinuteHand = Util.inputStreamToString(is);

			is = this.getClass().getResourceAsStream("/clothing/wrist_mens_watch_hourhand.svg");
			mensWatchHourHand = Util.inputStreamToString(is);
			is = this.getClass().getResourceAsStream("/clothing/wrist_mens_watch_minutehand.svg");
			mensWatchMinuteHand = Util.inputStreamToString(is);

			is = this.getClass().getResourceAsStream("/statusEffects/weatherDayClear.svg");
			weatherDayClear = Util.inputStreamToString(is);
			is = this.getClass().getResourceAsStream("/statusEffects/weatherDayCloudy.svg");
			weatherDayCloud = Util.inputStreamToString(is);
			is = this.getClass().getResourceAsStream("/statusEffects/weatherDayRain.svg");
			weatherDayRain = Util.inputStreamToString(is);
			is = this.getClass().getResourceAsStream("/statusEffects/weatherDaySnow.svg");
			weatherDaySnow = Util.inputStreamToString(is);
			is = this.getClass().getResourceAsStream("/statusEffects/weatherDayStormIncoming.svg");
			weatherDayStormIncoming = Util.inputStreamToString(is);
			is = this.getClass().getResourceAsStream("/statusEffects/weatherDayStorm.svg");
			weatherDayStorm = Util.inputStreamToString(is);
			is = this.getClass().getResourceAsStream("/statusEffects/weatherDayStormProtected.svg");
			...
			is = this.getClass().getResourceAsStream("/statusEffects/weatherNightClear.svg");
			weatherNightClear = Util.inputStreamToString(is);
			is = this.getClass().getResourceAsStream("/statusEffects/weatherNightCloudy.svg");
			weatherNightCloud = Util.inputStreamToString(is);
			is = this.getClass().getResourceAsStream("/statusEffects/weatherNightRain.svg");
			weatherNightRain = Util.inputStreamToString(is);
			is = this.getClass().getResourceAsStream("/statusEffects/weatherNightSnow.svg");
			weatherNightSnow = Util.inputStreamToString(is);
			is = this.getClass().getResourceAsStream("/statusEffects/weatherNightStormIncoming.svg");
			weatherNightStormIncoming = Util.inputStreamToString(is);
			is = this.getClass().getResourceAsStream("/statusEffects/weatherNightStorm.svg");
			weatherNightStorm = Util.inputStreamToString(is);
			is = this.getClass().getResourceAsStream("/statusEffects/weatherNightStormProtected.svg");
			...
			is = this.getClass().getResourceAsStream("/UIElements/protection.svg");
			...
			is = this.getClass().getResourceAsStream("/UIElements/tattoo.svg");
			tattoo = Util.inputStreamToString(is);
			tattoo = setColour(tattoo, PresetColour.CLOTHING_BLACK);
			

			is = this.getClass().getResourceAsStream("/UIElements/responseCombat.svg");
			responseCombat = Util.inputStreamToString(is);
			is = this.getClass().getResourceAsStream("/UIElements/responseSex.svg");
			responseSex = Util.inputStreamToString(is);
			is = this.getClass().getResourceAsStream("/UIElements/responseLocked.svg");
			responseLocked = Util.inputStreamToString(is);
			responseLocked = setColour(responseLocked, PresetColour.GENERIC_BAD);
			
			is = this.getClass().getResourceAsStream("/UIElements/responseUnlocked.svg");
			...
			is = this.getClass().getResourceAsStream("/UIElements/responseOption.svg");
			...
			is = this.getClass().getResourceAsStream("/UIElements/responseCorruptionBypass.svg");
			...
			is = this.getClass().getResourceAsStream("/UIElements/responseSubResist.svg");
			responseSubResist = Util.inputStreamToString(is);
			is = this.getClass().getResourceAsStream("/UIElements/responseSubNormal.svg");
			responseSubNormal = Util.inputStreamToString(is);
			is = this.getClass().getResourceAsStream("/UIElements/responseSubEager.svg");
			responseSubEager = Util.inputStreamToString(is);
			is = this.getClass().getResourceAsStream("/UIElements/responseDomGentle.svg");
			responseDomGentle = Util.inputStreamToString(is);
			is = this.getClass().getResourceAsStream("/UIElements/responseDomNormal.svg");
			responseDomNormal = Util.inputStreamToString(is);
			is = this.getClass().getResourceAsStream("/UIElements/responseDomRough.svg");
			responseDomRough = Util.inputStreamToString(is);

			is = this.getClass().getResourceAsStream("/UIElements/responseSexSwitch.svg");
			responseSexSwitch = Util.inputStreamToString(is);
			is = this.getClass().getResourceAsStream("/UIElements/responseSexAdditional.svg");
			responseSexAdditional = Util.inputStreamToString(is);
			
			
			is = this.getClass().getResourceAsStream("/UIElements/responseNPC.svg");
			...
			is = this.getClass().getResourceAsStream("/UIElements/slaveJob.svg");
			...
			is = this.getClass().getResourceAsStream("/UIElements/slavePermissions.svg");
			slavePermissions = Util.inputStreamToString(is);
			slavePermissions = setColour(slavePermissions, PresetColour.BASE_GREY);
			
			is = this.getClass().getResourceAsStream("/UIElements/slavePermissionsDisabled.svg");
			...
			is = this.getClass().getResourceAsStream("/UIElements/slaveTransfer.svg");
			...
			is = this.getClass().getResourceAsStream("/UIElements/slaveCosmetics.svg");
			...
			is = this.getClass().getResourceAsStream("/UIElements/transactionBuy.svg");
			transactionBuy = Util.inputStreamToString(is);
			
			is = this.getClass().getResourceAsStream("/UIElements/transactionBuyDisabled.svg");
			...
			is = this.getClass().getResourceAsStream("/UIElements/transactionBid.svg");
			...
			is = this.getClass().getResourceAsStream("/UIElements/transactionSell.svg");
			transactionSell = Util.inputStreamToString(is);
			
			is = this.getClass().getResourceAsStream("/UIElements/transactionSellDisabled.svg");
			...
			for(int i=1; i<=9; i++) {
				is = this.getClass().getResourceAsStream("/statusEffects/race/raceFoxTail"+i+".svg");
			...
			is = this.getClass().getResourceAsStream("/statusEffects/creampie.svg");
			creampie = Util.inputStreamToString(is);
			is = this.getClass().getResourceAsStream("/statusEffects/creampieMasochist.svg");
			creampieMasochist = Util.inputStreamToString(is);

			is = this.getClass().getResourceAsStream("/statusEffects/fluidIngested.svg");
			fluidIngested = Util.inputStreamToString(is);
			is = this.getClass().getResourceAsStream("/statusEffects/fluidIngestedMasochist.svg");
			fluidIngestedMasochist = Util.inputStreamToString(is);
			
			
			// Items:
			
			is = this.getClass().getResourceAsStream("/items/hypnoClockBase.svg");
			hypnoWatchBase = Util.inputStreamToString(is);
			hypnoWatchBase = setColour(hypnoWatchBase, PresetColour.BASE_GREY);
			
			is = this.getClass().getResourceAsStream("/items/hypnoClockEnchanted.svg");
			...
			is = this.getClass().getResourceAsStream("/statusEffects/sexEffects/coverableAreaAnus.svg");
			coverableAreaAnus = Util.inputStreamToString(is);
			is = this.getClass().getResourceAsStream("/statusEffects/sexEffects/coverableAreaAss.svg");
			coverableAreaAss = Util.inputStreamToString(is);
			is = this.getClass().getResourceAsStream("/statusEffects/sexEffects/coverableAreaMouth.svg");
			coverableAreaMouth = Util.inputStreamToString(is);
			is = this.getClass().getResourceAsStream("/statusEffects/sexEffects/coverableAreaBreasts.svg");
			coverableAreaBreasts = Util.inputStreamToString(is);
			is = this.getClass().getResourceAsStream("/statusEffects/sexEffects/coverableAreaBreastsFlat.svg");
			coverableAreaBreastsFlat = Util.inputStreamToString(is);
			is = this.getClass().getResourceAsStream("/statusEffects/sexEffects/coverableAreaNipple.svg");
			coverableAreaNipple = Util.inputStreamToString(is);
			is = this.getClass().getResourceAsStream("/statusEffects/sexEffects/coverableAreaVagina.svg");
			coverableAreaVagina = Util.inputStreamToString(is);
			is = this.getClass().getResourceAsStream("/statusEffects/sexEffects/coverableAreaMound.svg");
			coverableAreaMound = Util.inputStreamToString(is);
			

			is = this.getClass().getResourceAsStream("/statusEffects/sexEffects/coverableAreaBreastsCrotch.svg");
			coverableAreaBreastsCrotch = Util.inputStreamToString(is);
			is = this.getClass().getResourceAsStream("/statusEffects/sexEffects/coverableAreaUdders.svg");
			coverableAreaUdders = Util.inputStreamToString(is);
			is = this.getClass().getResourceAsStream("/statusEffects/sexEffects/coverableAreaNippleCrotch.svg");
			coverableAreaNippleCrotch = Util.inputStreamToString(is);

			is = this.getClass().getResourceAsStream("/statusEffects/sexEffects/coverableAreaUrethraVagina.svg");
			coverableAreaUrethraVagina = Util.inputStreamToString(is);
			is = this.getClass().getResourceAsStream("/statusEffects/sexEffects/coverableAreaUrethraPenis.svg");
			coverableAreaUrethraPenis = Util.inputStreamToString(is);
			
			is = this.getClass().getResourceAsStream("/statusEffects/sexEffects/coverableAreaThighs.svg");
			coverableAreaThighs = Util.inputStreamToString(is);
			
			is = this.getClass().getResourceAsStream("/statusEffects/sexEffects/penetrationTypeFinger.svg");
			penetrationTypeFinger = Util.inputStreamToString(is);
			is = this.getClass().getResourceAsStream("/statusEffects/sexEffects/penetrationTypePenis.svg");
			penetrationTypePenis = Util.inputStreamToString(is);
			is = this.getClass().getResourceAsStream("/statusEffects/sexEffects/penetrationTypeTail.svg");
			penetrationTypeTail = Util.inputStreamToString(is);
			is = this.getClass().getResourceAsStream("/statusEffects/sexEffects/penetrationTypeTongue.svg");
			penetrationTypeTongue = Util.inputStreamToString(is);
			is = this.getClass().getResourceAsStream("/statusEffects/sexEffects/penetrationTypeFoot.svg");
			penetrationTypeFoot = Util.inputStreamToString(is);
			is = this.getClass().getResourceAsStream("/statusEffects/sexEffects/penetrationTypeClit.svg");
			penetrationTypeClit = Util.inputStreamToString(is);
			
			
			is = this.getClass().getResourceAsStream("/statusEffects/sexEffects/combinationStretching.svg");
			...
			is = this.getClass().getResourceAsStream("/statusEffects/sexEffects/combinationStretchRecoveryPrevented.svg");
			...
			is = this.getClass().getResourceAsStream("/statusEffects/sexEffects/combinationTooLoose.svg");
			...
			is = this.getClass().getResourceAsStream("/statusEffects/sexEffects/combinationWet.svg");
			...
			is = this.getClass().getResourceAsStream("/statusEffects/sexEffects/combinationDry.svg");
			...
			is = this.getClass().getResourceAsStream("/statusEffects/sexEffects/combinationDepthMinimum.svg");
			...
			is = this.getClass().getResourceAsStream("/statusEffects/sexEffects/combinationDepthMaximum.svg");
			...
			is = this.getClass().getResourceAsStream("/statusEffects/sexEffects/stretching.svg");
			stretching = Util.inputStreamToString(is);
			is = this.getClass().getResourceAsStream("/statusEffects/sexEffects/holeTooBig.svg");
			holeTooBig = Util.inputStreamToString(is);

			is = this.getClass().getResourceAsStream("/statusEffects/sexEffects/active_background.svg");
			activeSexBackground = Util.inputStreamToString(is);
			
			
			String tempString = "";
			for(AbstractItemEffectType effect : ItemEffectType.getAllEffectTypes()) {
				is = this.getClass().getResourceAsStream("/items/refined_background.svg");
			...
			for(TFModifier secondaryModifier : TFModifier.values()) {
				is = this.getClass().getResourceAsStream("/items/refined_swirls.svg");
				tempString = Util.inputStreamToString(is);
