...
public class Main extends Application {
	...
	public static final Image WINDOW_IMAGE = new Image(Main.class.getResource("/images/windowIcon32.png").toString());
	...
	public void start(Stage primaryStage) throws Exception {
		...
		if (properties.hasValue(PropertyValue.lightTheme)) {
			mainScene.getStylesheets().add("/css/stylesheet_light.css");
		} else {
