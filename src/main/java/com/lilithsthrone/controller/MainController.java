...
//							Main.game.getPlayer().getClothingInSlot(InventorySlot.NECK).setColour(0, PresetColour.CLOTHING_GOLD);
	...
	private void setUpWebViews() {
		...
		if (Main.getProperties().hasValue(PropertyValue.lightTheme)) {
			webEngineTooltip.setUserStyleSheetLocation(getClass().getResource("/css/webViewTooltip_stylesheet_light.css").toExternalForm());
		} else {
			webEngineTooltip.setUserStyleSheetLocation(getClass().getResource("/css/webViewTooltip_stylesheet.css").toExternalForm());
		}
...
//		webEngine.setJavaScriptEnabled(false);
		...
		if (Main.getProperties().hasValue(PropertyValue.lightTheme)) {
			webEngine.setUserStyleSheetLocation(getClass().getResource("/css/webView_stylesheet_light.css").toExternalForm());
		} else {
			webEngine.setUserStyleSheetLocation(getClass().getResource("/css/webView_stylesheet.css").toExternalForm());
		}
		...
		if (Main.getProperties().hasValue(PropertyValue.lightTheme)) {
			webEngineButtonsLeft.setUserStyleSheetLocation(getClass().getResource("/css/webViewButtons_stylesheet_light.css").toExternalForm());
		} else {
			webEngineButtonsLeft.setUserStyleSheetLocation(getClass().getResource("/css/webViewButtons_stylesheet.css").toExternalForm());
		}
		...
		if (Main.getProperties().hasValue(PropertyValue.lightTheme)) {
			webEngineButtonsRight.setUserStyleSheetLocation(getClass().getResource("/css/webViewButtons_stylesheet_light.css").toExternalForm());
		} else {
			webEngineButtonsRight.setUserStyleSheetLocation(getClass().getResource("/css/webViewButtons_stylesheet.css").toExternalForm());
		}
		...
		if (Main.getProperties().hasValue(PropertyValue.lightTheme)) {
			webEngineAttributes.setUserStyleSheetLocation(getClass().getResource("/css/webViewAttributes_stylesheet_light.css").toExternalForm());
		} else {
			webEngineAttributes.setUserStyleSheetLocation(getClass().getResource("/css/webViewAttributes_stylesheet.css").toExternalForm());
		}
		...
		if (Main.getProperties().hasValue(PropertyValue.lightTheme)) {
			webEngineRight.setUserStyleSheetLocation(getClass().getResource("/css/webViewAttributes_stylesheet_light.css").toExternalForm());
		} else {
			webEngineRight.setUserStyleSheetLocation(getClass().getResource("/css/webViewAttributes_stylesheet.css").toExternalForm());
		}
...
//					Main.game.setContent(new Response("", "", Main.game.getDefaultDialogue(false)));
	...
	public void switchTheme() {
		if (Main.getProperties().hasValue(PropertyValue.lightTheme)) {
			getWebEngineTooltip().setUserStyleSheetLocation(getClass().getResource("/css/webViewTooltip_stylesheet.css").toExternalForm());
			getWebEngine().setUserStyleSheetLocation(getClass().getResource("/css/webView_stylesheet.css").toExternalForm());
			getWebEngineButtonsLeft().setUserStyleSheetLocation(getClass().getResource("/css/webViewButtons_stylesheet.css").toExternalForm());
			getWebEngineButtonsRight().setUserStyleSheetLocation(getClass().getResource("/css/webViewButtons_stylesheet.css").toExternalForm());
			getWebEngineAttributes().setUserStyleSheetLocation(getClass().getResource("/css/webViewAttributes_stylesheet.css").toExternalForm());
			getWebEngineRight().setUserStyleSheetLocation(getClass().getResource("/css/webViewAttributes_stylesheet.css").toExternalForm());
	
			Main.mainScene.getStylesheets().clear();
			Main.mainScene.getStylesheets().add("/css/stylesheet.css");
			Main.primaryStage.setScene(Main.mainScene);
		} else {
			getWebEngineTooltip().setUserStyleSheetLocation(getClass().getResource("/css/webViewTooltip_stylesheet_light.css").toExternalForm());
			getWebEngine().setUserStyleSheetLocation(getClass().getResource("/css/webView_stylesheet_light.css").toExternalForm());
			getWebEngineButtonsLeft().setUserStyleSheetLocation(getClass().getResource("/css/webViewButtons_stylesheet_light.css").toExternalForm());
			getWebEngineButtonsRight().setUserStyleSheetLocation(getClass().getResource("/css/webViewButtons_stylesheet_light.css").toExternalForm());
			getWebEngineAttributes().setUserStyleSheetLocation(getClass().getResource("/css/webViewAttributes_stylesheet_light.css").toExternalForm());
			getWebEngineRight().setUserStyleSheetLocation(getClass().getResource("/css/webViewAttributes_stylesheet_light.css").toExternalForm());
	
			Main.mainScene.getStylesheets().clear();
			Main.mainScene.getStylesheets().add("/css/stylesheet_light.css");
			Main.primaryStage.setScene(Main.mainScene);
		}
