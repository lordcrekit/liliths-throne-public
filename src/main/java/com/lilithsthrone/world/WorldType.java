...
public class WorldType {
	...
	public static AbstractWorldType WORLD_MAP = new AbstractWorldType("Lilith's Realm",
			...
			"/map/global/world_map.png", null, null, Util.newHashMapOfValues(
	...
	public static AbstractWorldType DOMINION = new AbstractWorldType("Dominion",
			...
			true,
			TeleportPermissions.BOTH,
			"/map/dominion/dominion.png", PlaceType.WORLD_MAP_DOMINION, PlaceType.DOMINION_PLAZA, Util.newHashMapOfValues(
	...
	public static AbstractWorldType EMPTY = new AbstractWorldType("Empty (Holding world)",
			...
			"/map/empty.png", PlaceType.WORLD_MAP_DOMINION, PlaceType.GENERIC_EMPTY_TILE, Util.newHashMapOfValues(
					new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
	...
	public static AbstractWorldType MUSEUM = new AbstractWorldType("Museum",
			...
			true,
			TeleportPermissions.NONE,
			"/map/prologue/museum.png", PlaceType.WORLD_MAP_DOMINION, PlaceType.MUSEUM_ENTRANCE, Util.newHashMapOfValues(
					new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
	...
	public static AbstractWorldType MUSEUM_LOST = new AbstractWorldType("Museum",
			...
			true,
			TeleportPermissions.NONE,
			"/map/prologue/museum_lost.png", PlaceType.WORLD_MAP_DOMINION, PlaceType.MUSEUM_MIRROR, Util.newHashMapOfValues(
					new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
					new Value<>(new Color(0xff8000), PlaceType.MUSEUM_ROOM),
	...
	public static AbstractWorldType LILAYAS_HOUSE_GROUND_FLOOR = new AbstractWorldType("Lilaya's Home GF",
			...
			false,
			TeleportPermissions.BOTH,
			"/map/dominion/lilayasHome/lilayas_home_ground_floor.png", PlaceType.WORLD_MAP_DOMINION, PlaceType.LILAYA_HOME_ENTRANCE_HALL, Util.newHashMapOfValues(
					new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
	...
	public static AbstractWorldType LILAYAS_HOUSE_FIRST_FLOOR = new AbstractWorldType("Lilaya's Home 1F",
			...
			false,
			TeleportPermissions.BOTH,
			"/map/dominion/lilayasHome/lilayas_home_first_floor.png", PlaceType.WORLD_MAP_DOMINION, PlaceType.LILAYA_HOME_STAIR_DOWN, Util.newHashMapOfValues(
					new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
					new Value<>(new Color(0x808080), PlaceType.LILAYA_HOME_CORRIDOR),
	...
	public static AbstractWorldType ZARANIX_HOUSE_FIRST_FLOOR = new AbstractWorldType("Zaranix's Home 1F",
			...
			"/map/dominion/zaranixHome/first_floor.png", PlaceType.WORLD_MAP_DOMINION, PlaceType.ZARANIX_FF_STAIRS, Util.newHashMapOfValues(
					new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
	...
	public static AbstractWorldType ZARANIX_HOUSE_GROUND_FLOOR = new AbstractWorldType("Zaranix's Home GF",
			...
			false,
			TeleportPermissions.OUTGOING_ONLY,
			"/map/dominion/zaranixHome/ground_floor.png", PlaceType.WORLD_MAP_DOMINION, PlaceType.ZARANIX_GF_ENTRANCE, Util.newHashMapOfValues(
					new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
	...
	public static AbstractWorldType HARPY_NEST = new AbstractWorldType("Harpy Nests",
			...
			true,
			TeleportPermissions.BOTH,
			"/map/dominion/harpyNests/harpyNests.png", PlaceType.WORLD_MAP_DOMINION, PlaceType.HARPY_NESTS_ENTRANCE_ENFORCER_POST, Util.newHashMapOfValues(
					new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
	...
	public static AbstractWorldType SLAVER_ALLEY = new AbstractWorldType("Slaver Alley",
			...
			true,
			TeleportPermissions.BOTH,
			"/map/dominion/slaverAlley/slaverAlley.png", PlaceType.WORLD_MAP_DOMINION, PlaceType.SLAVER_ALLEY_ENTRANCE, Util.newHashMapOfValues(
					new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
	...
	public static AbstractWorldType SHOPPING_ARCADE = new AbstractWorldType("Shopping Arcade",
			...
			true,
			TeleportPermissions.BOTH,
			"/map/dominion/shoppingArcade/shoppingArcade.png", PlaceType.WORLD_MAP_DOMINION, PlaceType.SHOPPING_ARCADE_ENTRANCE, Util.newHashMapOfValues(
					new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
	...
	public static AbstractWorldType SUPPLIER_DEN = new AbstractWorldType("Supplier Depot",
			...
			false,
			TeleportPermissions.OUTGOING_ONLY,
			"/map/dominion/shoppingArcade/supplierDen.png",
	...
	public static AbstractWorldType ENFORCER_HQ = new AbstractWorldType("Enforcer HQ",
			...
			false,
			TeleportPermissions.OUTGOING_ONLY,
			"/map/dominion/enforcerHQ/enforcerHQ.png",
	...
	public static AbstractWorldType ENFORCER_WAREHOUSE = new AbstractWorldType("SWORD Warehouse",
			...
			false,
			TeleportPermissions.NONE,
			"/map/dominion/enforcerWarehouse/enforcerWarehouse.png",
	...
	public static AbstractWorldType CITY_HALL = new AbstractWorldType("City Hall",
			...
			false,
			TeleportPermissions.OUTGOING_ONLY,
			"/map/dominion/cityHall/city_hall.png", PlaceType.WORLD_MAP_DOMINION, PlaceType.CITY_HALL_ENTRANCE, Util.newHashMapOfValues(
					new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
	...
	public static AbstractWorldType HOME_IMPROVEMENTS = new AbstractWorldType("Argus's DIY Depot",
			...
			false,
			TeleportPermissions.OUTGOING_ONLY,
			"/map/dominion/homeImprovements/homeImprovements.png", PlaceType.WORLD_MAP_DOMINION, PlaceType.HOME_IMPROVEMENTS_ENTRANCE, Util.newHashMapOfValues(
					new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
	...
	public static AbstractWorldType DOMINION_EXPRESS = new AbstractWorldType("Dominion Express",
			...
			false,
			TeleportPermissions.OUTGOING_ONLY,
			"/map/dominion/dominionExpress/dominionExpress.png", PlaceType.WORLD_MAP_DOMINION, PlaceType.HOME_IMPROVEMENTS_ENTRANCE, Util.newHashMapOfValues(
					new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
	...
	public static AbstractWorldType ANGELS_KISS_GROUND_FLOOR = new AbstractWorldType("Angel's Kiss GF",
			...
			false,
			TeleportPermissions.BOTH,
			"/map/dominion/angelsKiss/angelsKissGroundFloor.png", PlaceType.WORLD_MAP_DOMINION, PlaceType.ANGELS_KISS_ENTRANCE, Util.newHashMapOfValues(
					new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
	...
	public static AbstractWorldType ANGELS_KISS_FIRST_FLOOR = new AbstractWorldType("Angel's Kiss 1F",
			...
			false,
			TeleportPermissions.BOTH,
			"/map/dominion/angelsKiss/angelsKissFirstFloor.png", PlaceType.WORLD_MAP_DOMINION, PlaceType.ANGELS_KISS_STAIRCASE_DOWN, Util.newHashMapOfValues(
					new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
					new Value<>(new Color(0x808080), PlaceType.ANGELS_KISS_CORRIDOR),
	...
	public static AbstractWorldType NIGHTLIFE_CLUB = new AbstractWorldType("The Watering Hole",
			...
			false,
			TeleportPermissions.NONE,
			"/map/dominion/nightLife/wateringHole.png", PlaceType.WORLD_MAP_DOMINION, PlaceType.WATERING_HOLE_ENTRANCE, Util.newHashMapOfValues(
					new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
	...
	public static AbstractWorldType DADDYS_APARTMENT = new AbstractWorldType("Daddy's apartment",
			...
			false,
			TeleportPermissions.NONE,
			"/map/dominion/daddy/apartment.png", PlaceType.WORLD_MAP_DOMINION, PlaceType.DOMINION_DEMON_HOME_DADDY, Util.newHashMapOfValues(
					new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
	...
	public static AbstractWorldType HELENAS_APARTMENT = new AbstractWorldType("Helena's apartment",
			...
			false,
			TeleportPermissions.NONE,
			"/map/dominion/helenaApartment/apartment.png", PlaceType.WORLD_MAP_DOMINION, PlaceType.DOMINION_HELENA_HOTEL, Util.newHashMapOfValues(
					new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
	...
	public static AbstractWorldType SUBMISSION = new AbstractWorldType("Submission",
			...
			true,
			TeleportPermissions.BOTH,
			"/map/submission/submission.png", PlaceType.WORLD_MAP_DOMINION, PlaceType.SUBMISSION_ENTRANCE, Util.newHashMapOfValues(
					new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
	...
	public static AbstractWorldType LYSSIETH_PALACE = new AbstractWorldType("Lyssieth's Palace",
			...
			false,
			TeleportPermissions.OUTGOING_ONLY,
			"/map/submission/lyssiethsPalace/groundFloor.png", PlaceType.WORLD_MAP_DOMINION, PlaceType.LYSSIETH_PALACE_ENTRANCE, Util.newHashMapOfValues(
					new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
	...
	public static AbstractWorldType IMP_FORTRESS_ALPHA = new AbstractWorldType("Imp Fortress A",
			...
			true,
			TeleportPermissions.OUTGOING_ONLY,
			"/map/submission/impFortress/fortress1Map.png", PlaceType.WORLD_MAP_DOMINION, PlaceType.FORTRESS_ALPHA_ENTRANCE, Util.newHashMapOfValues(
					new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
	...
	public static AbstractWorldType IMP_FORTRESS_DEMON = new AbstractWorldType("Imp Citadel",
			...
			true,
			TeleportPermissions.OUTGOING_ONLY,
			"/map/submission/impFortress/fortress2Map.png", PlaceType.WORLD_MAP_DOMINION, PlaceType.FORTRESS_DEMON_ENTRANCE, Util.newHashMapOfValues(
					new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
	...
	public static AbstractWorldType IMP_FORTRESS_FEMALES = new AbstractWorldType("Imp Fortress F",
			...
			true,
			TeleportPermissions.OUTGOING_ONLY,
			"/map/submission/impFortress/fortress3Map.png", PlaceType.WORLD_MAP_DOMINION, PlaceType.FORTRESS_FEMALES_ENTRANCE, Util.newHashMapOfValues(
					new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
	...
	public static AbstractWorldType IMP_FORTRESS_MALES = new AbstractWorldType("Imp Fortress M",
			...
			true,
			TeleportPermissions.OUTGOING_ONLY,
			"/map/submission/impFortress/fortress4Map.png", PlaceType.WORLD_MAP_DOMINION, PlaceType.FORTRESS_MALES_ENTRANCE, Util.newHashMapOfValues(
					new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
	...
	public static AbstractWorldType BAT_CAVERNS = new AbstractWorldType("Bat Caverns",
			...
			true,
			TeleportPermissions.BOTH,
			"/map/submission/batCaverns/batCaverns.png", PlaceType.WORLD_MAP_DOMINION, PlaceType.BAT_CAVERN_ENTRANCE, Util.newHashMapOfValues(
					new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
	...
	public static AbstractWorldType SLIME_QUEENS_LAIR_GROUND_FLOOR = new AbstractWorldType("Slime Queen's Tower GF",
			...
			false,
			TeleportPermissions.OUTGOING_ONLY,
			"/map/submission/slimeQueensLair/slimeQueensLairGroundFloor.png", PlaceType.WORLD_MAP_DOMINION, PlaceType.SLIME_QUEENS_LAIR_ENTRANCE, Util.newHashMapOfValues(
					new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
	...
	public static AbstractWorldType SLIME_QUEENS_LAIR_FIRST_FLOOR = new AbstractWorldType("Slime Queen's Tower 1F",
			...
			false,
			TeleportPermissions.OUTGOING_ONLY,
			"/map/submission/slimeQueensLair/slimeQueensLairFirstFloor.png", PlaceType.WORLD_MAP_DOMINION, PlaceType.SLIME_QUEENS_LAIR_STAIRS_DOWN, Util.newHashMapOfValues(
					new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
	...
	public static AbstractWorldType GAMBLING_DEN = new AbstractWorldType("Gambling Den",
			...
			false,
			TeleportPermissions.OUTGOING_ONLY,
			"/map/submission/gamblingDen/gamblingDen.png", PlaceType.WORLD_MAP_DOMINION, PlaceType.GAMBLING_DEN_ENTRANCE, Util.newHashMapOfValues(
					new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
	...
	public static AbstractWorldType RAT_WARRENS = new AbstractWorldType("Rat Warrens",
			...
			false,
			TeleportPermissions.NONE,
			"/map/submission/ratWarrens/ratWarrens.png",
